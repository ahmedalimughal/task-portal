                  ...
                  <div class="card m-b-20 card-body">
                     ...
                     <form action="post-task-action" method="post" >
                        <div class="form-floating">
                           ...
                           <textarea class="form-control" name="task_name" onKeyUp="countLines(this)" placeholder="Enter task name" 
                              ...
                              <textarea class="form-control" name="camp_link" placeholder="Enter Camp Link" 
                               id="floatingTextarea2" style="height: 100px" required="Please Enter your Task" rows="10" cols="70"></textarea>
                           
                           <label for="floatingTextarea2">Enter Your Task Count</label>
                           <input class="form-control mb-3" name="task_count" type="number" value="" required="Please Enter your Task" id="example-number-input" placeholder="Enter Task Count " disable>
                        </div>
                        <button class="btn badge-success waves-effect waves-light text-light" type="submit">Confirm Added</button>
                        <a href="my-tasks" target="_blank" type="redirect" class="btn badge-primary  waves-effect waves-light" action >Show My Task</a>
                     </form>
                  </div>
               </div>
