...
<html lang="en">
   <head>
      ...
      <title>Update your task | <?php echo htmlspecialchars($_SESSION["name"]);?></title>
                     ...
                     <form name="form1" method="post" action="update_task_action.php">
                        <div class="form-floating">
                           ...
                           <textarea class="form-control" name="task_name"  placeholder="Update task name" 
                              ...
                              <label for="floatingTextarea2">Update Your Camp Links 1 per line</label>
                           <textarea class="form-control" name="camp_link"  placeholder="Update task name" 
                              style="height:250px; " id="floatingTextarea2" style="height: auto !important" required="Please Update your Task"><?php echo $camp_link;?></textarea>
