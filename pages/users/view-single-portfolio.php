                            ...
                            <div class="card-body">
                              <a href="<?php echo $image_src;  ?>" target="_blank">
                                ...
                                <blockquote class="card-blockquote mb-0">
                                    ...
                                    <p>Click Here To Visit Website : <a href="<?php echo $website_url;?>" target="_blank"><?php echo $website_name ?></a></p>
                                    <p>Click Here To Visit Project Camp Link : <a href="<?php echo $camp_link; ?>" target="_blank">Project Camp Link</a></p>
                                    <footer class="blockquote-footer text-muted">
